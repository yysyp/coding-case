...
public class GitBashRunnerShFileAndParams2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File dir = new File("springboot-liquibase-demo/src/main/resources/ignore");
        ...
        Map<String, List<String>> result = CmdRunTool2.runCmds(new File("springboot-liquibase-demo/src/main/resources/ignore"),
        ...
        Map<String, List<String>> result2 = CmdRunTool2.runCmds("GBK", new File("springboot-liquibase-demo/src/main/resources/ignore"),
                new HashMap<>(),
                "cmd.exe",
                "/c",
                "ipconfig /all");
        ...
        Map<String, List<String>> result22 = CmdRunTool2.runCmds("GBK", new File("springboot-liquibase-demo/src/main/resources/ignore"),
                new HashMap<>(),
                command.split(" "));
        ...
        System.out.println("RUN command: "+ command);
        Map<String, List<String>> result3 = CmdRunTool2.runCmds("GBK", new File("springboot-liquibase-demo/src/main/resources/ignore"),
                new HashMap<>(),
                command.split(" "));
