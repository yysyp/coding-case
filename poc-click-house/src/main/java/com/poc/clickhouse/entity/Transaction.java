package com.poc.clickhouse.entity;

import io.swagger.v3.oas.annotations.media.Schema;
import java.time.LocalDateTime;

/**
 * Financial transaction entity for storing transaction data in ClickHouse.
 * This entity represents a typical financial transaction record.
 */
...
public class Transaction {
    ...
    public Transaction(Long id, Double amount, String currency, String transactionType, 
