...
- **Swagger UI**: [http://localhost:29235/swagger-ui.html](http://localhost:29235/swagger-ui.html)
- **H2 Console**: [http://localhost:29235/h2-console](http://localhost:29235/h2-console)
