...
- **Swagger UI**: [http://localhost:27012/swagger-ui.html](http://localhost:27012/swagger-ui.html)
- **H2 Console**: [http://localhost:27012/h2-console](http://localhost:27012/h2-console)
