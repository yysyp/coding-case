...
public class PocDemoApplication {
    ...
    public CommandLineRunner demo(ApplicationContext ctx) {
        ...
        System.out.println("--->>aquick-poc-mpt: PocDemoApplication.demo()");
        return (args) -> {

            Environment environment = ctx.getBean(Environment.class);
            System.out.println("--->>aquick-poc-mpt: user.dir = " + environment.getProperty("user.dir"));

            System.out.println("--->>aquick-poc-mpt: CommandLineRunner.demo() End");
            System.out.println("--->>aquick-poc-mpt swagger ui: http://localhost:20001/swagger-ui.html");
