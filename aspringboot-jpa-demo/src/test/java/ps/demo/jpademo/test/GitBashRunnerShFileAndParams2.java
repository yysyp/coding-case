...
//        );
//
//        File dir = new File("aspringboot-jpa-demo/src/main/resources/ignore");
...
//        CmdRunTool2.printCmdResult(CmdRunTool2.runCmds(dir, env, cmds), System.out);
        ...
        Map<String, List<String>> result = CmdRunTool2.runCmds(new File("aspringboot-jpa-demo/src/main/resources/ignore"),
        ...
        Map<String, List<String>> result2 = CmdRunTool2.runCmds("GBK", new File("aspringboot-jpa-demo/src/main/resources/ignore"),
                new HashMap<>(),
                "cmd.exe",
                "/c",
                "ipconfig /all");
        ...
        Map<String, List<String>> result22 = CmdRunTool2.runCmds("GBK", new File("aspringboot-jpa-demo/src/main/resources/ignore"),
                new HashMap<>(),
                command.split(" "));
        ...
        System.out.println("RUN command: "+ command);
        Map<String, List<String>> result3 = CmdRunTool2.runCmds("GBK", new File("aspringboot-jpa-demo/src/main/resources/ignore"),
                new HashMap<>(),
                command.split(" "));
