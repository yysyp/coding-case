...
import ps.demo.zglj.common.SettingTool;
import ps.demo.zglj.entity.Book;
import ps.demo.zglj.entity.Role;
import ps.demo.zglj.repository.BookRepository;
import ps.demo.zglj.repository.RoleRepository;
import ps.demo.zglj.service.RoleService;
...
public class Doczgljtodo20ptApplication {

    public static void main(String[] args) {
        System.setProperty("JASYPT_ENCRYPTOR_PASS", SettingTool.getConfigByKey("JASYPT_ENCRYPTOR_PASS"));
        SpringApplication.run(Doczgljtodo20ptApplication.class, args);
    }
